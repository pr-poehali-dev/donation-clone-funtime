...
const RANKS = [
  ...
  },
  {
    ...
    color: "hsl(210 80% 58%)",
    emoji: "💎",
    perks: ["Приставка [PREMIUM]", "/fly без ограничений", "10 точек дома", "/heal & /feed", "Доступ к /tpa"],
    popular: true,
  },
  {
    id: "elite",
    ...
    color: "hsl(43 95% 55%)",
    emoji: "👑",
    perks: ["Приставка [ELITE]", "Все права PREMIUM", "Приоритетный вход", "Доступ к /god", "Партиклы и эффекты"],
  },
  {
    id: "legend",
    cls: "rank-legend",
    ...
    color: "hsl(265 70% 62%)",
    emoji: "🔮",
    perks: ["Приставка [LEGEND]", "Все права ELITE", "Доступ к /v", "Личная арена PvP", "Уникальный плащ", "Поддержка 24/7"],
  },
];
